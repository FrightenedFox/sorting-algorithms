...
def CreateInput(path=".\\tests\\test.txt", complexity = 0, Nmin = 0, Nmax = 1000, inputs = 10,
	len_start = 10, len_incr = 1, len_mult = 1, distrib = None):
	...
	inputs 		- number of inputs in the resulting file
	...
	for i in range(inputs):
		if complexity == 0:
			...
			AppendFile(path = path, out_list = sequence, end='\n')
